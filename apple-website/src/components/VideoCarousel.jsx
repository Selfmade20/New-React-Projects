...
const handleProcess = (type, i) => {
  ...
  return (
    <>
      ...
      <div className='relative flex-center scroller'>
        <div className='flex-center py-5 px-7 bg-gray-800 backdrop-blur-2xl rounded-full'>
          {videoRef.current.map((_, i) => (
            <span 
            key={i} 
            ref={(el) => (videoDivRef.current[i] = el)}
            className='scroller_dots rounded-full relative cursor-pointer'
            >
